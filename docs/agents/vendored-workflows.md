...
Saturday, `* * 1` = Monday. Rows are ordered by UTC time within each table.
...
## `improve-codebase-architecture` — Saturdays

| Repo | cron (UTC) | CT (CDT) | timeout | budget | issues/run |
|---|---|---|---|---|---|
| moodreader | `3 0 * * 6` | Fri 19:03 | 20m | $3 | 1 |
| skills | `5 0 * * 6` | Fri 19:05 | 20m | $3 | 5 |
| tweakcc-maint | `34 1 * * 6` | Fri 20:34 | 20m | $3 | 1 |
| agent-research | `4 3 * * 6` | Fri 22:04 | 20m | $3 | 1 |
| goodreads-bot | `11 3 * * 6` | Fri 22:11 | 20m | $3 | 1 |

- **Issue cap:** skills host = 5; consumers = 1 (one-issue-per-run).
...
| Repo | cron (UTC) | CT (CDT) | timeout | budget | issues/run |
|---|---|---|---|---|---|
| moodreader | `39 0 * * 6` | Fri 19:39 | 20m | $3 | 5 |
| skills | `19 1 * * 6` | Fri 20:19 | 20m | $3 | 5 |
| goodreads-bot | `45 1 * * 6` | Fri 20:45 | 20m | $3 | 5 |
| tweakcc-maint | `27 3 * * 6` | Fri 22:27 | 20m | $3 | 5 |
| agent-research | `37 3 * * 6` | Fri 22:37 | 20m job / 15m run | **$15** | 5 |
...
- `improve-codebase-architecture` + `apply-agent-research`: **Saturday 00–04 UTC**
  (Fri evening CT).
- `staleness-review`: **first Monday 13:xx UTC** (08:xx CT) — except moodreader
  (see outlier above).

No cron collisions across the current estate (verified).
