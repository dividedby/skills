...
- **[doc-it](./skills/engineering/doc-it/SKILL.md)** — Scan a repo and generate or patch its reference docs (README, API docs, onboarding, CHANGELOG) from source; audit existing ADRs and CONTEXT.md for staleness and report findings without editing them.
